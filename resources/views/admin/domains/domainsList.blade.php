        ...
        <table id="dataTableExample" class="table">
            <thead>
                <tr>
                    ...
                    <th class="">Grade</th>
                    <th class="text-right">Total Score(In Percent)</th>
                    <th class="text-center">Latest Scan Date</th>
                        ...
                        <tr>
                            ...
                            <td class="action-button" width="200px;">
                                ...
                                @if($action_display ?? ' ')    
                                    ...
                                    @endif
                                    <a class="text-primary" href="{{ url('admin/domain-rescan/'.$Data->id.'/admin')}}"><img src="{{asset('img/scan-icon.svg')}}" data-toggle="tooltip" title="Active Domain"/>
                                @endif    
                            </td>
                        </tr>
                    @endforeach
