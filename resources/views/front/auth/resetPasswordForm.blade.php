...
@section('content')
 <div class="main-wrapper">
        <div class="login-signup-box d-flex justify-content-center w-100 reset-page">
            <div class="form-box">
                <form action="{{url('reset-password-process',$id)}}" method="post">
                	@csrf
                    <div class="form-head">
                    ...
                    <div class="form-button text-center">
                        <button type="submit" class="btn btn-secondary d-block w-100">Update</button>
                    </div>
                    <div class="text-center mt-3">
						<a href="{{url('admin')}}" class="text-white">Already Have An Account? <b>Login</b></a>	
					</div>
                </form>
            </div>
        </div>
